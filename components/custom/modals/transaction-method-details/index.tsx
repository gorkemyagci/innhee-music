                ...
                {isInvite ? <Invite /> : (
                    <>
                        <div className="flex flex-col items-center gap-2.5">
                            ...
                            />
                            <p className="text-strong-950 font-medium text-lg">Thanks for the order!</p>
                        </div>
                        <div className="bg-weak-50 p-5 rounded-[12px] flex flex-col items-center gap-4">
                            <div className="flex flex-col items-center gap-1">
                                <p className="text-strong-950 font-medium text-base">What would you like to do next?</p>
                                <p className="text-sub-600 font-normal text-sm text-center">
                                    <span className="font-bold">Invite</span> workers or contact customer service for assistance.
                                </p>
                            </div>
