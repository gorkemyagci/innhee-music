    ...
    return (
        <div className="w-full max-w-[1440px] mx-auto flex flex-col py-10 md:py-16 lg:py-20 items-center justify-center gap-8 md:gap-12 lg:gap-16 px-4 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 lg:gap-6 w-full max-w-[1200px] mx-auto">
                <div className="group border border-[#E5E5E5] rounded-2xl bg-white p-4 shadow-sm flex flex-col gap-4 md:gap-5 lg:gap-6 items-start transition-all duration-300 hover:shadow-lg hover:shadow-gray-100 hover:-translate-y-1 hover:border-gray-200">
                    ...
                    <div className="w-full flex items-center justify-center py-2.5 bg-[#FAFAFA] border border-[#E5E5E5] rounded-xl overflow-hidden group-hover:bg-gray-50 transition-colors duration-300">
                        <Image
                            src="/assets/images/features/translucent.png"
                            alt={t("features.feature1.title")}
                            width={297}
                            height={227}
                            className="w-full h-auto max-w-[297px] pointer-events-none rounded-xl object-cover transition-transform duration-300 group-hover:scale-105"
                            quality={100}
                        />
                    </div>
                </div>
                <div className="group border border-[#E5E5E5] rounded-2xl bg-white p-4 shadow-sm flex flex-col gap-4 md:gap-5 lg:gap-6 items-start transition-all duration-300 hover:shadow-lg hover:shadow-gray-100 hover:-translate-y-1 hover:border-gray-200">
                    ...
                    <div className="w-full flex items-center justify-center py-2.5 bg-[#FAFAFA] border border-[#E5E5E5] rounded-xl overflow-hidden group-hover:bg-gray-50 transition-colors duration-300">
                        <Image
                            ...
                            width={395}
                            height={259}
                            className="w-full h-auto max-w-[395px] pointer-events-none object-cover transition-transform duration-300 group-hover:scale-105"
                            quality={100}
                        />
                    </div>
                </div>
                <div className="group border border-[#E5E5E5] rounded-2xl bg-white p-4 shadow-sm flex flex-col gap-4 md:gap-5 lg:gap-6 items-start md:col-span-2 lg:col-span-1 transition-all duration-300 hover:shadow-lg hover:shadow-gray-100 hover:-translate-y-1 hover:border-gray-200">
                    <div className="flex flex-col items-start gap-2 md:gap-3">
