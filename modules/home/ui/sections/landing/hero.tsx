    ...
    return <div className="relative w-full flex items-center flex-col px-4 lg:px-8">
        ...
        <div className="w-full flex flex-col md:flex-row items-stretch gap-4 max-w-[1200px] mt-10 mx-auto md:gap-6">
            <div className="flex-1 relative bg-[#1B1B1B] p-6 md:p-8 rounded-2xl flex flex-col items-start border-2 gap-6 md:gap-8 border-[#E5E5E5]">
                ...
                <Button variant="outline" className="bg-gradient-to-r w-[100px] h-10 from-white/40 to-white/10 px-4 md:px-6 py-1.5 md:py-2 z-10 text-white font-semibold text-sm md:text-base rounded-full border border-white/50">Buyers</Button>
                    <p className="text-white font-semibold text-2xl">Find Top Audio Talent</p>
                    <span className="text-disabled-300 text-base md:text-lg font-medium">Post jobs, set budgets, and find the right audio professionals fast.</span>
                </div>
            ...
            <div className="flex-1 relative bg-white p-6 md:p-8 rounded-2xl flex flex-col items-start border-2 gap-6 md:gap-8 border-[#E5E5E5]">
                ...
                />
                <div className="flex flex-col items-start gap-2 md:gap-3">
                    <Button variant="outline" className="bg-gradient-to-r w-[111px] h-10 from-[#BEADAD]/50 to-[#7D7D7D]/10 px-4 md:px-6 py-1.5 md:py-2 z-10 text-black text-sm md:text-base font-semibold rounded-full border border-[#0C0502]/20">Workers</Button>
                    <p className="text-black font-semibold text-2xl">Earn with Your Skills</p>
