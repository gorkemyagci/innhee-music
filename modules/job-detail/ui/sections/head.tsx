...
const Head = () => {
    return <div className="w-full h-10 flex items-center justify-between pr-2.5">
        <div className="flex items-center gap-2 overflow-x-auto whitespace-nowrap">
            <span className="text-xs md:text-sm font-medium text-sub-600">Find Works</span>
            <Icons.chevron_short_right className="flex-shrink-0" />
            <span className="text-sub-600 font-medium text-xs md:text-sm">Project Detail</span>
        </div>
        <ReportMessage>
