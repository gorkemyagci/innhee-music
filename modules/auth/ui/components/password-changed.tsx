...
const PasswordChanged = () => {
    return (
        <div className="w-96 p-4 lg:p-8 bg-white shadow-sm z-10 rounded-3xl flex flex-col items-center gap-6">
            ...
            <Button  className="w-full bg-[#20232D] hover:bg-[#20232D]/90 transition-all h-10 border border-[#57585a] rounded-xl text-white text-sm font-medium shadow-[0_0_1px_#242628] relative overflow-hidden">
                Go To Website
            </Button>
        </div>
    )
