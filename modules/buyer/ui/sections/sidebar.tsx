...
const Sidebar = () => {
    return <div className="w-[352px] shrink-0 max-h-[calc(100vh-120px)] shadow-sm bg-white border border-soft-200 rounded-[20px] pb-6">
        <div className="p-4 relative flex flex-col items-center gap-5">
            ...
            <div className="flex items-center gap-5">
                <Button variant="outline" className="w-[85px] h-8 border-soft-200 rounded-lg bg-white flex items-center gap-1.5 text-sub-600 font-medium text-sm">
